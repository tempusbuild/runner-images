...
| Python (toolcache, prebake)   | `3.10.20`, `3.11.15`, `3.12.13`, `3.13.13`, `3.14.6` in `/opt/hostedtoolcache/Python/<v>/x64` (ARG `PYTHON_31x`)                                                                                  | actions/python-versions `versions-manifest.json` — same builds `setup-python` fetches |
